...
export function DataTableFilterList<TData>({
    ...
    const columns = React.useMemo(() => {
        return table.getAllColumns().filter((column) => {
            return column.columnDef.accessorKey || column.columnDef.meta?.filterVariant;
        });
    }, [table]);
    ...
    const [pendingFilters, setPendingFilters] = React.useState<ExtendedColumnFilter<TData>[]>([]);
    ...
    const applyFilters = () => {
        ...
        const columnFiltersState = pendingFilters.map((filter) => ({
            id: filter.id,
            value: filter.value,
        }));
...
// Giữ nguyên DataTableFilterItem và onFilterInputRender
