...
>(({ className, value, onValueChange, placeholder, disabled, mode = "single" }, ref) => {
...
>(({ placeholder, ...props }, ref) => {
  ...
  React.useEffect(() => {
    if (isRangeMode) {
      setInputValue(formatDateTimeRange(value as DateRange));
    } else {
