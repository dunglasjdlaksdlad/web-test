      ...
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            ...
            "body group/sidebar-wrapper has-data-[variant=inset]:bg-sidebar flex min-h-svh w-full",
            className
          )}
          {...props}
        >
    ...
    >
      ...
      <div
        className={cn(
          ...
          // "relative h-svh w-(--sidebar-width) body transition-[width] duration-200 ease-linear",
